<template>
	<div class="max-w-md w-full lg:flex shadow-lg m-2 rounded" @click="$refs.siteLink.click()">
	  ...
	  <div class="bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal w-full">
	    <div class="mb-4">
	      <a class="text-black font-bold text-xl no-underline" :href="link" target="_blank" rel="noopener" ref="siteLink">{{ title }}</a>
